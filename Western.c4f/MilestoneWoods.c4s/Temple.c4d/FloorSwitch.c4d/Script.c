...
protected func Timer10()
  ...
  var iWgt, obj;
  while (obj = FindObject(idSpezial, -25,-7,50,13, 0, 0,0, NoContainer(), obj))
  ...
  if(iNeededWeight) { if (iWgt >= iNeededWeight) iDesiredY = _FLS_DownPos; }
  else if (iWgt >= _FLS_NeededWeight) iDesiredY = _FLS_DownPos;
